...
<html lang="en">
    ...
    <head>
        ...
        <link type="text/css" href="<?php echo base_url(); ?>assets/dashboard/dist/css/bootstrap-tagsinput.css" rel="stylesheet" />
        <script src="<?php echo base_url(); ?>assets/dashboard/vendor/jquery/jquery.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/dashboard/dist/js/bootstrap-tagsinput.js"></script>
        <script src="<?php echo base_url(); ?>assets/dashboard/dist/js/nicEdit.js"></script>
